...
{
    public static IOptions<WriteSpeechOptions> Create(Action<WriteSpeechOptions>? configure = null)
    {
    ...
    public static IOptionsMonitor<WriteSpeechOptions> CreateMonitor(Action<WriteSpeechOptions>? configure = null)
    {
        var options = new WriteSpeechOptions();
        configure?.Invoke(options);
        return new TestOptionsMonitor<WriteSpeechOptions>(options);
    }
}
