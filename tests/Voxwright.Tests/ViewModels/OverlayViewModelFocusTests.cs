...
public class OverlayViewModelFocusTests : IDisposable
{
    ...
    private readonly VoxwrightOptions _optionsValue;
    ...
    public OverlayViewModelFocusTests()
    {
        ...
        _optionsValue = new VoxwrightOptions();
    }

    private OverlayViewModel CreateViewModel(Action<VoxwrightOptions>? configure = null)
    {
