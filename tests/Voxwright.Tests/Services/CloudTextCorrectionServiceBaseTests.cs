...
{
    private TestCorrectionService CreateService(Action<VoxwrightOptions>? configure = null)
    {
    ...
    public async Task CorrectAsync_UsesDictionaryFragment()
    {
        ...
        service.LastSystemPrompt.Should().Contain("[Custom: Voxwright]");
    }
    ...
    public void BuildCorrectionPrompt_AppendsDictionaryAndIdeFragments()
    {
        ...
        systemPrompt.Should().Contain("[Dict: Voxwright]");
    ...
    private class TestCorrectionService : CloudTextCorrectionServiceBase
    {
        ...
        public TestCorrectionService(
            ...
            Microsoft.Extensions.Options.IOptionsMonitor<VoxwrightOptions> optionsMonitor,
